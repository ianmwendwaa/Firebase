...
import com.mwendwa.morningfirebase.models.Upload
...
class productviewmodel(var navController: NavHostController, var context: Context) {
    ...
    fun saveProduct(productName: String, productQuantity: String, productPrice: String) {
        ...
        var productData = com.mwendwa.morningfirebase.models.Product(
            productName,
            productQuantity,
            productPrice,
            id
    ...
    fun viewProducts(
        product: MutableState<com.mwendwa.morningfirebase.models.Product>,
        products: SnapshotStateList<com.mwendwa.morningfirebase.models.Product>
    ): SnapshotStateList<com.mwendwa.morningfirebase.models.Product> {
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (snap in snapshot.children) {
                    val value = snap.getValue(com.mwendwa.morningfirebase.models.Product::class.java)
                    product.value = value!!
                    products.add(value)
                }
            }
    ...
    fun updateProduct(name: String, quantity: String, price: String, id: String) {
        var updateRef = FirebaseDatabase.getInstance().getReference()
            .child("Products/$id")
        progress.show()
        var updateData = com.mwendwa.morningfirebase.models.Product(name, quantity, price, id)
